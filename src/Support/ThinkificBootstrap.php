...
final class ThinkificBootstrap
{
    public static function registerAutoload(): void
    {
        ...
        spl_autoload_register(static function (string $class): void {
            $prefix = 'PaymentEngine\\Thinkific\\';
    ...
    private static function requirePhpSdk(): void
    {
        ...
        throw new \RuntimeException('Remita Checkout PHP SDK bootstrap file could not be found for Thinkific.');
    }
}
